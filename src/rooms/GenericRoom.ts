...
export class GenericRoom extends Room<State> {
  ...
  onCreate() {
    ...
    console.log(this.sceneName + ' room created!')
  }
  ...
  onJoin(client: Client) {
    ...
    console.log('Player ' + client.sessionId + ' joined ' + this.sceneName + ' room.')
  }

  onLeave(client: Client) {
    this.broadcast('playerLeaveRoom', { id: client.sessionId })
    this.state.players.delete(client.sessionId)
    console.log('Player ' + client.sessionId + ' leaved ' + this.sceneName + ' room.')
  }

  onDispose() {
    console.log(this.sceneName + ' ' + this.roomId + ' disposing...')
  }
